        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            ...
            <div class="grid grid-cols-12 gap-5 mt-5">
                <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box p-5 cursor-pointer zoom-in">
                    <div class="font-medium text-base">Hoodies</div>
                ...
                <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box bg-theme-1 p-5 cursor-pointer zoom-in">
                    <div class="font-medium text-base text-white">Crewnecks</div>
                    <div class="text-theme-25">8 Items</div>
                </div>
                <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box p-5 cursor-pointer zoom-in">
                    <div class="font-medium text-base">T-Shirts</div>
            ...
            <div class="grid grid-cols-12 gap-5 mt-5 pt-5 border-t border-theme-5">
                    ...
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-9.jpg') ?>">
                            </div>
                        </div>
                ...
                <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 xxl:col-span-3">
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-2.jpg') ?>">
                            </div>
                        </div>
                ...
                <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 xxl:col-span-3">
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-15.jpg') ?>">
                            </div>
                        </div>
                ...
                <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 xxl:col-span-3">
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-6.jpg') ?>">
                            </div>
                        </div>
                ...
                <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 xxl:col-span-3">
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-14.jpg') ?>">
                            </div>
                        </div>
                ...
                <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 xxl:col-span-3">
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-13.jpg') ?>">
                            </div>
                        </div>
                ...
                <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 xxl:col-span-3">
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-10.jpg') ?>">
                            </div>
                        </div>
                ...
                <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="intro-y block col-span-12 sm:col-span-4 xxl:col-span-3">
                    <div class="box rounded-md p-3 relative zoom-in">
                        <div class="flex-none pos-image relative block">
                            <div class="pos-image__preview image-fit">
                                <img alt="Midone Tailwind HTML Admin Template" src="<?= base_url('dist/images/food-beverage-1.jpg') ?>">
                            </div>
                        </div>
                ...
                <div class="tab-content__pane active" id="ticket">
                    <div class="pos__ticket box p-2 mt-5">
                        <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">
                            ...
                            <div class="ml-auto">Rp 112.000</div>
                        </a>
                        <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">
                    ...
                    <div class="box p-5 mt-5">
                        ...
                        <div class="flex mt-4">
                            ...
                            <div class="text-theme-6">-Rp 20.000</div>
                        </div>
                        <div class="flex mt-4">
                        ...
                        <div class="flex mt-4 pt-4 border-t border-gray-200">
                            ...
                            <div class="font-medium text-base">RP 220.000</div>
                        </div>
                    </div>
                    <div class="flex mt-5">
                    ...
                    <div class="box p-5 mt-5">
                        ...
                        <div class="flex items-center border-b py-5">
                            <div class="">
                                ...
                                <div>Jalan Mastrip No.55 Gg 2 Sumbersari</div>
                            </div>
        ...
        <div class="modal__content">
            ...
            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                <div class="col-span-12">
                    <label>Name</label>
                    <div class="mt-2">
                        <select class="select2 w-full border mt-2 flex-1">
                ...
                <div class="col-span-12">
                    ...
                    <textarea name="address" id="address" class="input w-full border mt-2 flex-1" placeholder="Custommer Address"></textarea>
                </div>
                <div class="col-span-12">
                    <label>Payment</label>
                    <div class="mt-2">
                        <select class="select2 w-full border mt-2 flex-1">
                            <option selected disabled hidden>Choose Payment</option>
