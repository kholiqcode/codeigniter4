    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="text-center whitespace-no-wrap">IMAGES</th>
                ...
                <tbody>
                    <?php for ($i = 1; $i <= 20; $i++) { ?>
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-no-wrap">Abdul Kholiq</a>
                                <div class="text-gray-600 text-xs whitespace-no-wrap">Pelanggan</div>
                            </td>
                            <td class="text-center">085959591196</td>
                            <td class="w-40">
