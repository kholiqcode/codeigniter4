                            ...
                            <td class="w-40">
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?= base_url('dist/images/preview-4.jpg') ?>" title="Uploaded at 26 November 2021">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?= base_url('dist/images/preview-5.jpg') ?>" title="Uploaded at 26 November 2021">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?= base_url('dist/images/preview-1.jpg') ?>" title="Uploaded at 26 November 2021">
                                    </div>
                                </div>
                            </td>
                            <td>
                                <a href="" class="font-medium whitespace-no-wrap">Hoodie Pancoat</a>
                                <div class="text-gray-600 text-xs whitespace-no-wrap">Hoodie</div>
                            </td>
                            <td class="text-center">0</td>
                            <td class="w-40">
                                <div class="flex items-center justify-center text-theme-6"> <i data-feather="check-square" class="w-4 h-4 mr-2"></i> Out of Stock </div>
                            </td>
